...
public enum Tables {
	...
	WIN_DATA ("CREATE TABLE IF NOT EXISTS `wins`" +
			           "(ID INTEGER PRIMARY KEY AUTOINCREMENT, UUID TEXT NOT NULL, KEY_ID TEXT NOT NULL, CRATE_TYPE TEXT NOT NULL, PRIZE_ID TEXT NOT NULL, WIN_TIME DATETIME NOT NULL);");
